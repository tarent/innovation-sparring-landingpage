      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center">
          <h2 className="text-3xl tracking-tight font-bold text-gray-900 sm:text-4xl sm:tracking-tight">
            Best Practices aus der Produktentwicklung
          </h2>
          <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            Unsere Mission ist es, dass Produktteams in Deutschland erfolgreiche Produkte entwickeln. Hier schreiben wir darüber.
          </p>
        </div>
